...
export async function listSources(
  ...
  return {
    results: {
      sources: [
        {
          name: 'Liberian Legal Information Portal',
          authority: 'lawliberian.com (Liberian Legal Information Portal)',
          url: 'https://www.lawliberian.com',
          license: 'Government Open Data',
          coverage:
            'Federal proclamations, regulations, and directives published in the Federal Negarit Gazette. ' +
            'Includes the Constitution of Liberia (1995), major legislative acts from 1995 to present, ' +
