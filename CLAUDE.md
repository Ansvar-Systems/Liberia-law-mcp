# Liberia Law MCP Server — Developer Guide
...
Liberia Law MCP server providing Liberian legislation search via Model Context Protocol. Strategy A deployment (Vercel, bundled SQLite DB). Covers data protection, cybercrimes, ICT, companies, consumer protection, and other key Acts.
...
- Liberia uses "Section N" for Acts and "Article N" for the Constitution
...
1. `scripts/ingest.ts` -> fetches from Liberia Law -> JSON seed files in `data/seed/`
...
- **Liberia Law** (liberianlaw.org) -- National Council for Law Reporting
- **License:** Government Open Data
- **Languages:** English (en) is the primary legal language; Swahili (sw) for some documents
- **Coverage:** All Acts of Parliament, subsidiary legislation, Constitution of Liberia 2010, selected case law

## Liberia-Specific Notes

- Liberia uses a common law legal system inherited from British colonial administration
- The Constitution of Liberia 2010 is the supreme law (Article 2)
...
- For the Constitution: "Article N, Constitution of Liberia 2010"
...
- npm package: `@ansvar/liberian-law-mcp` with bin entry for stdio
