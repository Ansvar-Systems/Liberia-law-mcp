#!/usr/bin/env tsx
/**
 * Liberia Law MCP -- Census Script
 *
 * Enumerates ALL proclamations, regulations, and directives from lawliberian.com.
...
const BASE_URL = 'https://www.lawliberian.com';
...
const FEDERAL_CATEGORIES = [
  ...
  'banking-and-monetary-system/national-bank-of-liberian',
  ...
  'parliament', 'police', 'president-of-liberian', 'prison',
...
async function scrapeCategoryPage(categoryPath: string): Promise<RawLaw[]> {
  ...
  for (const link of links) {
    ...
    if (link.href.startsWith('http') && !link.href.includes('lawliberian.com')) continue;
...
async function main(): Promise<void> {
  ...
  console.log('Liberia Law MCP -- Census Script');
  console.log('=================================\n');
  ...
  console.log(`  Jurisdiction:   Liberia (ET)`);
  console.log(`  Source:         ${BASE_URL}`);
