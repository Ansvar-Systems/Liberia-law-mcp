/**
 * Liberia Law PDF Parser
 *
 * Parses text extracted from Liberian proclamation PDFs (Federal Negarit Gazette).
...
export function parseLiberiaLawHtml(html: string, act: ActIndexEntry): ParsedAct {
  return parsePdfText(html, act);
}
